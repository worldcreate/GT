...
int main(void){
	...
	j1.first=1;j1.second=6;
	j2.first=2;j2.second=2;
	j3.first=0;j3.second=2;
	j4.first=0;j4.second=3;
	j5.first=1;j5.second=5;
	j6.first=2;j6.second=4;
	/*
	...
	*/
	...
	gt.setTable(table);
	gt.execute();
	vector<vector<Gt::Time> > result=gt.getASTable();
